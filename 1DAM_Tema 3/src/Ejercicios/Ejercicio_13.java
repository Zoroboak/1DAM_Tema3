...
public class Ejercicio_13 {
	...
	/* MÉTODO: VALIDACIÓN DE NUMERO DE CARACTERES */
	...
	public static void main(String[] args) {
		...
		System.out.println("+-------------------------------------+");
		System.out.println("|                                     |");
		System.out.println("| VALIDACIÓN NUMERO CAPICÚA 7 DIGITOS |");
		System.out.println("|                                     |");
		System.out.println("+-------------------------------------+");
		...
		do{
			...
			switch(opc){
				case 1:	// PROGRAMA PRINCIPAL
					...
					do{
						System.out.println();
						System.out.print("Introduce un numero de 7 Digitos: ");
						num = t.nextInt();
						termina = 0;
						...
						if(validar(num)==true) {
							...
							System.out.println("El numero introducido no es de 7 digitos");
							termina = 1;
						}
